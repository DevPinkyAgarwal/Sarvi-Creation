...
class Title {
  ...
  createMesh() {
    ...
    const textHeight = this.plane.scale.y * 0.12; // Reduced size slightly
    ...
    this.program = new Program(this.gl, {
      ...
      vertex: `
        ...
        void main() {
          vUv = uv;
          vec3 p = position;
          p.z = (sin(p.x * 2.0 + uTime) * 0.3 + cos(p.y * 1.0 + uTime) * 0.3) * (0.05 + uSpeed * 0.2);
...
export declare interface CircularGalleryProps {
